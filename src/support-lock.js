...
registerPlugin(
    {
        ...
        version: '1.0.0',
        description:
            'With this script, the bot will automatically open and close a configurable support channel if atleast one member of configurable supporter groups is online.',
        author: 'Relentless',
        backends: ['ts3'],
        vars: [
            {
            ...
            {
                name: 'commandPersist',
                title: 'Persistent-Command > Do you want to disable automatic reopening/closing of the support channel after someone changed its status via command? If yes, the channel has to be manually opened/closed to activate the automation again.',
                type: 'select',
                options: ['Yes', 'No']
            },
            {
